package com.everis.bootcamp.msbootcoin.configuration;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, BootCoinTransactionDto> bootCoinProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, BootCoinTransactionDto> monederoKafkaTemplate() {

        KafkaTemplate<String, BootCoinTransactionDto> kafkaTemplate = new KafkaTemplate<>(bootCoinProducerFactory());
