...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, BootCoinTransactionDto> bootCoinConsumerFactory() {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, BootCoinTransactionDto> bootCoinKafkaListenerContainerFactory() {
		...
		factory.setConsumerFactory(bootCoinConsumerFactory());
		return factory;
	}
}
